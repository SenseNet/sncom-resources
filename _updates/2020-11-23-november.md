...
- Some error messages were not handled correctly on group membership dialog, not it is fixed. 💬 [#1080](https://github.com/SenseNet/sn-client/pull/1080)
...
- You can use now reference fields on you custom menuitem. ⏬ [#1021](https://github.com/SenseNet/sn-client/pull/1021)
